...
class LseSpider(scrapy.Spider):
    ...
    FirstPage= 'https://www.hl.co.uk/shares/stock-market-summary/ftse-all-share?page=1'
    start_urls = [FirstPage] +['https://www.hl.co.uk/shares/stock-market-summary/ftse-all-share?page=%s'% (page) for page in range(2,7)]
